...
```{r income}
sub_vdata = subset(vdata, vdata$pial1a > 0)
ggplot(aes(x=as.ordered(income), y=..count../sum(..count..)), data=sub_vdata) + 
  geom_histogram() +
  scale_y_continuous(limits=c(0,1)) +
  ylab("relative freq.") + xlab("income") +
  scale_x_discrete(breaks=c(1,2,3,4,9), 
                   labels=c("< $30K", "$30-49.4K", "$50-74.9K", "75K+",
                            "Refused"))
```
...
```{r 2a-1a}
sub_vdata = subset(vdata, vdata$pial1a > 0)
ggplot(aes(x=factor(pial2a),fill=factor(pial1a)), data=sub_vdata)+geom_bar(position="fill") +
  ylab("relative freq.") + xlab("Computers like human will happen?") +
  scale_x_discrete(breaks=c(1,2,3,4,5,8,9), 
                   labels=c("Def. YES", "Prob. YES", "Prob. NOT", "Def. NOT",
                            "Already", "Don't know", "Refused"))+
...
```{r 2b-1a}
sub_vdata = subset(vdata, vdata$pial1a > 0)
ggplot(aes(x=factor(pial2b),fill=factor(pial1a)), data=sub_vdata)+geom_bar(position="fill") +
  ylab("relative freq.") + xlab("Lab-made organs will happen?") +
  scale_x_discrete(breaks=c(1,2,3,4,5,8,9), 
                   labels=c("Def. YES", "Prob. YES", "Prob. NOT", "Def. NOT",
                            "Already", "Don't know", "Refused"))+
...
```{r 2c-1a}
sub_vdata = subset(vdata, vdata$pial1a > 0)
ggplot(aes(x=factor(pial2c),fill=factor(pial1a)), data=sub_vdata)+geom_bar(position="fill") +
  ylab("relative freq.") + xlab("Colonies on another planet will happen?") +
  scale_x_discrete(breaks=c(1,2,3,4,5,8,9), 
                   labels=c("Def. YES", "Prob. YES", "Prob. NOT", "Def. NOT",
                            "Already", "Don't know", "Refused"))+
...
```{r 2d-1a}
sub_vdata = subset(vdata, vdata$pial1a > 0)
ggplot(aes(x=factor(pial2d),fill=factor(pial1a)), data=sub_vdata)+geom_bar(position="fill") +
  ylab("relative freq.") + xlab("Weather control will happen?") +
  scale_x_discrete(breaks=c(1,2,3,4,5,8,9), 
                   labels=c("Def. YES", "Prob. YES", "Prob. NOT", "Def. NOT",
                            "Already", "Don't know", "Refused"))+
...
```{r 2e-1a}
sub_vdata = subset(vdata, vdata$pial1a > 0)
ggplot(aes(x=factor(pial2e),fill=factor(pial1a)), data=sub_vdata)+geom_bar(position="fill") +
  ylab("relative freq.") + xlab("Teleportation will happen?") +
  scale_x_discrete(breaks=c(1,2,3,4,5,8,9), 
                   labels=c("Def. YES", "Prob. YES", "Prob. NOT", "Def. NOT",
                            "Already", "Don't know", "Refused"))+
...
## PIAL4-a: Do you eat meat or not that was grown in a lab?
```{r 4a}
# 1.Yes 2.No 8.Don't know 9. Refused
ggplot(aes(x=as.ordered(pial4a), y=..count../sum(..count..)), data=vdata) + 
  geom_histogram() +
  scale_y_continuous(limits=c(0,1)) +
  ylab("relative freq.") + xlab("Eat meat that was grown in a lab") +
  scale_x_discrete(breaks=c(1,2,8,9), labels=c("Yes", "No", "Don't know", "Refused"))
```

## PIAL4-b: Do you ride or not in a driverless car?
```{r 4b}
# 1.Yes 2.No 8.Don't know 9. Refused
ggplot(aes(x=as.ordered(pial4b), y=..count../sum(..count..)), data=vdata) + 
  geom_histogram() +
  scale_y_continuous(limits=c(0,1)) +
  ylab("relative freq.") + xlab("Ride in a driverless car") +
  scale_x_discrete(breaks=c(1,2,8,9), labels=c("Yes", "No", "Don't know", "Refused"))
```

## PIAL4-c: Do you get or not a brain implant to improve your memory or mental capacity?
```{r 4c}
# 1.Yes 2.No 8.Don't know 9. Refused
ggplot(aes(x=as.ordered(pial4c), y=..count../sum(..count..)), data=vdata) + 
  geom_histogram() +
  scale_y_continuous(limits=c(0,1)) +
  ylab("relative freq.") + xlab("Get a brain implant to improve your memory or mental capacity") +
  scale_x_discrete(breaks=c(1,2,8,9), labels=c("Yes", "No", "Don't know", "Refused"))
```
...
```{r 4a-1a}
sub_vdata = subset(vdata, vdata$pial1a > 0)
ggplot(aes(x=factor(pial4a),fill=factor(pial1a)), data=sub_vdata)+geom_bar(position="fill") +
  ylab("relative freq.") + xlab("Eat meat that was grown in a lab") +
  scale_x_discrete(breaks=c(1,2,8,9), 
...
```{r 4b-1a}
sub_vdata = subset(vdata, vdata$pial1a > 0)
ggplot(aes(x=factor(pial4b),fill=factor(pial1a)), data=sub_vdata)+geom_bar(position="fill") +
  ylab("relative freq.") + xlab("Ride in a driverless car") +
  scale_x_discrete(breaks=c(1,2,8,9), 
                   labels=c("YES", "No", "Don't know", "Refused")) +
  scale_fill_discrete(name="Future will be..", breaks=c(1, 2, 8, 9),
...
```{r 4c-1a}
sub_vdata = subset(vdata, vdata$pial1a > 0)
ggplot(aes(x=factor(pial4c),fill=factor(pial1a)), data=sub_vdata)+geom_bar(position="fill") +
  ylab("relative freq.") + xlab("Get a brain implant to improve your memory or mental capacity") +
  scale_x_discrete(breaks=c(1,2,8,9), 
                   labels=c("YES", "No", "Don't know", "Refused")) +
  scale_fill_discrete(name="Future will be..", breaks=c(1, 2, 8, 9),
...
```{r 3a-1a}
sub_vdata = subset(vdata, vdata$pial1a > 0)
ggplot(aes(x=factor(pial3a),fill=factor(pial1a)), data=sub_vdata)+geom_bar(position="fill") +
  ylab("relative freq.") + xlab("Lifelike robots are a change for better/worse?") +
  scale_x_discrete(breaks=c(1,2,3,8,9), 
                   labels=c("Better", "Worse", "Good and Bad" , "Don't know", "Refused")) +
  scale_fill_discrete(name="Future will be..", breaks=c(1, 2, 8, 9),
                           labels=c("Better", "Worse", "Don't know", "Refused"))
```
...
```{r 3b-1a}
sub_vdata = subset(vdata, vdata$pial1a > 0)
ggplot(aes(x=factor(pial3b),fill=factor(pial1a)), data=sub_vdata)+geom_bar(position="fill") +
  ylab("relative freq.") + xlab("Drones are a change for Better or Worse?") +
  scale_x_discrete(breaks=c(1,2,3,8,9), 
                   labels=c("Better", "Worse", "Good and Bad" , "Don't know", "Refused")) +
  scale_fill_discrete(name="Future will be..", breaks=c(1, 2, 8, 9),
                           labels=c("Better", "Worse", "Don't know", "Refused"))
...
```{r 3c-1a}
sub_vdata = subset(vdata, vdata$pial1a > 0)
ggplot(aes(x=factor(pial3c),fill=factor(pial1a)), data=sub_vdata)+geom_bar(position="fill") +
  ylab("relative freq.") + xlab("Wearable devices are a change for Better or Worse?") +
  scale_x_discrete(breaks=c(1,2,3,8,9), 
                   labels=c("Better", "Worse", "Good and Bad" , "Don't know", "Refused")) +
  scale_fill_discrete(name="Future will be..", breaks=c(1, 2, 8, 9),
                           labels=c("Better", "Worse", "Don't know", "Refused"))
...
```{r 3d-1a}
sub_vdata = subset(vdata, vdata$pial1a > 0)
ggplot(aes(x=factor(pial3d),fill=factor(pial1a)), data=sub_vdata)+geom_bar(position="fill") +
  ylab("relative freq.") + xlab("Altering DNA is a change for Better or Worse?") +
  scale_x_discrete(breaks=c(1,2,3,8,9), 
                   labels=c("Better", "Worse", "Good and Bad" , "Don't know", "Refused")) +
  scale_fill_discrete(name="Future will be..", breaks=c(1, 2, 8, 9),
                           labels=c("Better", "Worse", "Don't know", "Refused"))
...
2. Histogram showing the relative frequency of income combined with future vs. income stacked bar plot. People with higher income are more positive about the future.

3. Histograms showing the relative frequency of attitudes toward each technology (PIAL4a-c) combined with a line graph showing the relative frequency of views on the future.
